# taken from https://github.com/FreddeFrallan/Non-Residual-Prompting/blob/master/Evaluation/CommonGenCoverage.py
...
def coverageScore(concept_sets, preds):
    covs = []
...
def originalCoverageScore(concept_sets, preds):
    covs = []
